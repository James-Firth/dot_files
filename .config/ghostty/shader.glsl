...
///////// JAMES CHANGED COLOURS VIA https://rgbcolorpicker.com/0-1 and https://draculatheme.com/contribute
...
const vec4 TRAIL_COLOR_ACCENT = vec4(1.0, 0.475, 0.776, 1.0); // pink
